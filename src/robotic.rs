...
pub enum Command {
    ...
    Set(ByteString, SignedNumeric, Option<SignedNumeric>),
    Inc(ByteString, SignedNumeric, Option<SignedNumeric>),
    Dec(ByteString, SignedNumeric, Option<SignedNumeric>),
    ...
    Give(SignedNumeric, Item),
    Take(SignedNumeric, Item, Option<ByteString>),
    EndGame,
    EndLife,
    Mod(ByteString),
    ...
    Multiply(ByteString, SignedNumeric),
    Divide(ByteString, SignedNumeric),
    Modulo(ByteString, SignedNumeric),
...
fn parse_opcode(buffer: &[u8], op: CommandOp) -> Option<Command> {
    ...
    let cmd = match op {
        ...
        CommandOp::ModFadeIn => one_arg(buffer, Command::ModFadeIn),
